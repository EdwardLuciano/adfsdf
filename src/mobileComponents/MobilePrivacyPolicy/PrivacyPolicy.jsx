...
export default function PrivacyPolicy({ setCart, cart, getCartTotal, getTotalSum, removeFromCart }) {
...
<h3 style={{color:'white',whiteSpace: 'pre-wrap',padding: '2px 38px', marginBlockStart: '0px'}}>Пользовательское соглашение</h3>
<pre style={{color:'white',whiteSpace: 'pre-wrap',padding: '2px 38px'}}>

{`Настоящий документ «Пользовательское соглашение» (далее — Соглашение) представляет собой предложение ИП Орлов Р.А., размещенное на сайте https://ramilmusic.com/ (далее — «Сайт»), заключить договор на изложенных ниже условиях Соглашения. 
...
2.1. Сайт осуществляет продажу товара посредством веб-ресурса https://ramilmusic.com/ и сопутствующих сервисных служб Сайта.
...
Подписываясь на SMS- и email-рассылку https://ramilmusic.com/ или третьих лиц, уполномоченных на рассылку от имени https://ramilmusic.com/ , в сети Интернет https://ramilmusic.com/ , я соглашаюсь получать информационную рассылку на телефон и электронный адрес, указанный мной при подписке через сервис подписки информационной рассылки на сайте https://ramilmusic.com/. Я проинформирован о том, что в случае, если у меня возникнет желание отказаться от информационной рассылки https://ramilmusic.com/, мне будет необходимо самостоятельно перейти по ссылке «Отписаться от рассылки», указанной в тексте отправляемых сайтом сообщений с электронного адреса Сайта https://ramilmusic.com/  или же сообщить о несогласии получения информационных рассылок по адресам, указанным в разделе «Контакты» данного Соглашения.
